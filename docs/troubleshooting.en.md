...
[日本語版 troubleshooting](troubleshooting.md)
...
- [docs/architecture.en.md](architecture.en.md) — Detailed architecture
- [docs/evidence_summary.en.md](evidence_summary.en.md) — A/B measurement + Phase evidence
