...
**Windows users required**: Use **forward slash** (`/`) in command paths. Backslash (`\`) gets stripped (`\w`, `\a`, `\h`, `\p`) by bash escape rules, causing path mangling that prevents hook startup. Details: [docs/troubleshooting.en.md](docs/troubleshooting.en.md)
...
- [README.en.md](README.en.md) — Overview + design philosophy
- [docs/architecture.en.md](docs/architecture.en.md) — Detailed architecture
- [docs/evidence_summary.en.md](docs/evidence_summary.en.md) — A/B measurement + per-Phase evidence
- [docs/troubleshooting.en.md](docs/troubleshooting.en.md) — Known issues + countermeasures
- [CONTRIBUTING.en.md](CONTRIBUTING.en.md) — Adding violation samples / TDD growth
